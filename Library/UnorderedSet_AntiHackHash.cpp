...
// Usage: unordered_map<long long, int, custom_hash> numbers;
// Usage: unordered_set<long long, custom_hash> numbers;
...
int main() {
	insert_numbers(107897); // blows up for non-custom hash!
